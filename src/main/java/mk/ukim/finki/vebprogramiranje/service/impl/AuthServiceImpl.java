...
import mk.ukim.finki.vebprogramiranje.model.exceptions.PasswordsDoNotMatchException;
import mk.ukim.finki.vebprogramiranje.repository.InMemoryUserRepository;
...
public class AuthServiceImpl implements AuthService {
    ...
    public User register(String username, String password, String repeatPassword, String name, String surname) {
        ...
        User user = new User(username,password,name,username);
